...
function fetchPage(page) {
   ...
   const pages = [
...

    {
      character: 'orc',
      page: 41,
      narrative: 'Orc: Uhm. Hello?! Excuse me?!',
      options: [
        { option: 'Say Hi',     nextPage: 2 },
        { option: 'Continue Ignoring, aint nobody got time for this!',   nextPage: 3 },
      ]
    },

    {
      ...
      options: [
        ...
        { option: 'Nah Don\'t think so',   nextPage: 4 },
      ]
    },

    {
      character: 'orc',
      page: 5,
      narrative: 'Orc: My sugar bowl of Honey Oats. Am I hard to understand? Are you hard of hearing? Some people\'s kids!!! I can\'t reach it by myself but I think you could really help.',
      options: [
        { option: ' Umm, I guess so. How do I help',   nextPage: 6 },
        { option: 'No I don\'t think so. That sounds like a ton of effort',   nextPage: 4 },
      ]
    },
...

    {
      character: 'orc',
      page: 10,
      narrative: 'Orc: Thank you so much, folks usually just slink away because of my appearance. It makes me so sad.',
      options: [
        { option: 'No problem! You seem like a great guy.',   nextPage: 11 },
        { option: 'Really? That is a dang shame!',   nextPage: 18 },
      ]
    },

    {
      character: 'orc',
      page: 18,
      narrative: 'Orc: Uhm. Yes? I\'m an orc? Did you miss that somehow? Are you blind?',
      options: [
        { option: 'I guess so. Geez, why you gotta be so mean?',   nextPage: 20 },
      ]
    },

    {
      ...
      options: [
        { option: 'Eat cookies. Om nom nom',   nextPage: 21 },
      ]
    },
